    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="rounded-lg border bg-card p-6 space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          VideoGata is committed to protecting your privacy. We collect minimal
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-lg border bg-muted/50 p-4 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            . If your browser sends Do Not Track, nothing is collected either
            way, whatever that setting says. A build with no analytics key
            configured, such as a self-hosted one, loads no analytics at all.
          </p>
        </div>
